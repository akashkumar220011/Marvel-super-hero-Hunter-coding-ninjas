window.onload = function () {
  ...
  // chracter details
  let url = `https://gateway.marvel.com:443/v1/public/characters/${id}?ts=1&apikey=5a6657d528e4dc9a7b383dd6f26de5dc&hash=2014ddc7cde357c0fe0ede7a05ec8054`;
  fetch(url)
    .then((response) => {
  ...
  url = `https://gateway.marvel.com:443/v1/public/characters/${id}/comics?ts=1&apikey=5a6657d528e4dc9a7b383dd6f26de5dc&hash=2014ddc7cde357c0fe0ede7a05ec8054`;
